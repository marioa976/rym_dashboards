...
$dbPortal = [
    ...
    'port'    => env_int('DB_PORT', 0),       // MAMP por defecto
    'name'    => env_str('DB_NAME', ''),
    'user'    => env_str('DB_USER', ''),
    'pass'    => env_str('DB_PASS', ''),      // MAMP por defecto
    'charset' => 'utf8mb4',
];
    ...
    'modulos' => [
        ...
        'qrobici' => [
            'db' => [                           // BD remota propia de Qrobici
                'host'    => env_str('QROBICI_DB_HOST', ''),
                'port'    => env_int('QROBICI_DB_PORT', 0),
                'name'    => env_str('QROBICI_DB_NAME', ''),
